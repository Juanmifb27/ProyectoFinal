...
-- Tiempo de generación: 12-05-2025 a las 08:38:27
...
(1, 'Nottingham Miedo', 'NM@iesruizgijon.com', 'Nottingham.png', 0, 0, 0, 0, 1),
(2, 'equipo novato 2', 'novato2@iesruizgijon.com', 'novato2.png', 0, 0, 0, 0, 1),
...
CREATE TABLE `jugadores` (
  ...
  `jugador_correo` varchar(150) NOT NULL,
  `jugador_curso` varchar(10) DEFAULT NULL,
...
ALTER TABLE `jugadores`
  ...
  ADD CONSTRAINT `jugadores_ibfk_2` FOREIGN KEY (`id_liga`) REFERENCES `ligas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
