                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <form class="form" id="formInscripcion" action="add-equipo.php?liga_id=<?php echo $liga_id; ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body row">
                                                            ...
                                                            <div class="form-group col-lg-12 col-sm-12">
                                                            <label for="equipo_liga">Liga Equipo</label>
                                                            <select class="form-select h-auto form-control-solid py-4 mx-3" name="equipo_liga">
                                                            <?php
                                                            $sqlLigas = "SELECT * FROM ligas";
                                                            $resLigas = $conexion->BD_Consulta($sqlLigas);
                                                            $tuplaLiga = $conexion->BD_GetTupla($resLigas);
                                                            if($liga_id == 0){
                                                                print("<option value=\"\" selected disabled> Selecciona una Liga</option>");
                                                            }else{
                                                                print("<option value=\"\" disabled> Selecciona una Liga</option>");
                                                            }
                                                            while($tuplaLiga != NULL){
                                                                if($tuplaLiga["id"] == $liga_id){
                                                                    print("<option value=\"" . $tuplaLiga["id"] ."\" selected>" . $tuplaLiga["nombre_liga"] . "</option>");
                                                                }else{
