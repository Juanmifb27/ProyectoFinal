                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <br>
                                                    <h6>Desde la pestaña Jugadores, podrás <strong>editar</strong> la información de un jugador, <strong>eliminar</strong> un jugador, <strong>ver</strong> todos los jugadores y <strong>añadir</strong> nuevos jugadores a un equipo.</h6>
                                                    <br>
                                                    <?php
                                                    if($vectorUsuario['rol'] == "AdministradorGeneral"){
                                                    print("<h6>Desde la pestaña Usuarios, podrás <strong>ver</strong> la información de los usuarios de los jugadores.</h6>
                                                    <br>");
                                                    }
                                                    ?>
                                                    ...
                                                    <div id="ayudaUsuario" hidden>
                                                        ...
                                                        <h6>Estos son algunos de los botones más basicos que encontrarás en casi todas las pestañas</h6>
                                                        <ol>
                                                            <li>
