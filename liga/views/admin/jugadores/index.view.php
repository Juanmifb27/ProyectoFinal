                                            ...
                                            <div id="ayudaUsuario" class="col-12" hidden>
                                                ...
                                                <ol>
                                                    ...
                                                    <li>
                                                        ...
                                                        <i class="fa-solid fa-arrow-right text-dark"></i>
                                                        <h6 class="d-inline">Sirve para editar informacion sobre el jugador.</h6>
                                                    </li>
                                                    <br>
                                                    <li>
                                                        ...
                                                        <i class="fa-solid fa-arrow-right text-dark"></i>
                                                        <h6 class="d-inline">Elimina COMPLETAMENTE el jugador seleccionado y su usuario</h6>
                                                    </li>
                                                    <br>
                                                    <li>
                                                        <a class=">
                                                        ...
                                                        <i class="fa-solid fa-arrow-right text-dark"></i>
                                                        <h6 class="d-inline">Puedes enviar un mensaje al correo asociado a ese jugador, con asunto, cuerpo y archivo.</h6>
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="mb-5 botonera text-right">
                                                        <a class="btn btn-lg btn-primary mr-1 btn-pill font-weight-bolder" href="./add-jugador.php">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-active align-middle gs-0 gy-4" id="TablaEquipos">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $sqlJugador = "SELECT jugadores.id, jugador_nombre, jugador_correo, jugador_curso, nombre_liga, nombre_equipo, jugadores.id_liga, jugadores.id_equipo  FROM jugadores, equipos, ligas where jugadores.id_equipo=equipos.id and jugadores.id_liga=ligas.id";
                                                                $resJugador = $conexion->BD_Consulta($sqlJugador);
                                                                $tuplaJugador = $conexion->BD_GetTupla($resJugador);
                                                                while ($tuplaJugador != NULL) {
                                                                    print("<tr class=\"text-center\">
                                                                    <td class=\"align-middle\">" . $tuplaJugador["jugador_nombre"] . "</td>
                                                                    <td class=\"align-middle\">" . $tuplaJugador["jugador_correo"] . "</td>
                                                                    <td class=\"align-middle\">" . $tuplaJugador["jugador_curso"] . "</td>
                                                                    ...
                                                                    print("<td class=\"text-right align-middle\">
                                                                        ...
                                                                        <a href=\"#\" class=\"btn btn-danger btn-pill btn-sm font-weight-bold\" data-toggle=\"modal\" data-target=\"#ModalEliminarJugador" . $tuplaJugador["id"] . "\">
                                                                            <span class=\"svg-icon svg-icon-white\"><svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\" version=\"1.1\">
                                                                                    <g stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\">
                                                                                        <rect x=\"0\" y=\"0\" width=\"24\" height=\"24\" />
                                                                                        <circle fill=\"#000000\" opacity=\"0.3\" cx=\"12\" cy=\"12\" r=\"10\" />
                                                                        ...
                                                                        <td class=\"text-right align-middle\">
                                                                        <a href=\"#\" data-toggle=\"modal\" data-target=\"#ModalEnviarCorreo" . $tuplaJugador["id"] ."\">
                                                                                <span class=\"svg-icon svg-icon-default\"><i class=\"fa-solid fa-paper-plane text-dark\"></i></span>
                                                                        </a>
                                                                    </td>


                                                                        <div class=\"modal fade\" id=\"ModalEliminarJugador" . $tuplaJugador["id"] . "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"CancelarModal\" aria-hidden=\"true\">
                                                                            <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">
                                                                                <div class=\"modal-content\">
                                                                                    <div class=\"modal-body\">
                                                                                        Va a eliminar el equipo <strong>" . $tuplaJugador["jugador_nombre"] . "</strong>.<br> ¿Está seguro de que quiere eliminarlo?
                                                                                    </div>
                                                                                    <div class=\"modal-footer\">
                                                                                        <button type=\"button\" class=\"btn btn-light-primary btn-pill font-weight-bold\" data-dismiss=\"modal\">CANCELAR</button>
                                                                                        <a href=\"index.php?id_jugador_del=" . $tuplaJugador["id"] . "\" class=\"btn btn-primary btn-pill font-weight-bold\">CONFIRMAR</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                    ...
                    <div class=\"modal-dialog modal-lg\" role=\"document\">
                        <div class=\"modal-content\">
                            <div class=\"modal-header\">
                                <h5 class=\"modal-title\" id=\"exampleModalLabel\">Enviar Correo a <strong>" . $tuplaJugador["jugador_correo"] ."</strong></h5>
                                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">
                                    <i aria-hidden=\"true\" class=\"ki ki-close\"></i>
                                </button>
                            </div>
                            <form class=\"form\" action=\"./index.php\" method=\"POST\" enctype='multipart/form-data'>
                            <input type=\"hidden\" name=\"aux_correo\" value=\"" . $tuplaJugador["jugador_correo"] . "\">
